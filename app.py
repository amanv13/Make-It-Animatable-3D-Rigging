...
def init_blocks():
    ...
    with gr.Blocks(title=title, delete_cache=(3600, 3660)) as demo:
        ...
        with gr.Row(variant="panel"):
            ...
            with gr.Column():
                with gr.Row():
                    input_3d = gr.File(label="Input 3D Model",file_types=[".fbx", ".glb", ".gltf", ".obj", ".ply", ".zip"],interactive=True)
                    ...
                    with gr.Row():
                        with gr.Accordion("Animation Settings", open=True):
                            ...
                            with gr.Row():
                                ...
                                input_animation_file = gr.File(label="Animation File",file_types=[".fbx"],value=lambda: "./data/Standard Run.fbx",interactive=True)
                            with gr.Row():
